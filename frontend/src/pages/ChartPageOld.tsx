    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button className="px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-colors">
            📋 Analisis Summary (PDF)
              ...
              <tr className="hover:bg-blue-25 bg-blue-50">
                <td className="py-3 px-4">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    <span className="font-medium text-blue-900">Lusa (Prediksi)</span>
                  </div>
                </td>
                <td className="text-center py-3 px-4">
                  <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">
              ...
              <tr className="hover:bg-blue-25 bg-blue-50">
                <td className="py-3 px-4">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                    <span className="font-medium text-blue-900">3 Hari (Prediksi)</span>
                  </div>
                </td>
                <td className="text-center py-3 px-4">
                  <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">
                ...
                <td className="text-center py-3 px-4 text-blue-700 font-medium">1.8</td>
                <td className="text-center py-3 px-4">
                  <span className="px-2 py-1 bg-success-100 text-success-700 rounded-full text-xs font-medium">
                    Optimal
                  </span>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div className="xl:col-span-2">
          {/* Chart Prediction Table - Replace PrediksiCard */}
          <div className="bg-white rounded-lg border border-primary-200 p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-lg font-semibold text-vmeds-900">Chart Prediksi Semua Indikator</h3>
                <p className="text-vmeds-600 text-sm mt-1">Proyeksi lengkap berdasarkan analisis machine learning</p>
              </div>
              <div className="text-xs text-vmeds-500 bg-vmeds-50 px-3 py-1 rounded-full">
                Model ARIMA - Akurasi: 94.2%
              </div>
            </div>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-primary-200 bg-primary-50">
                    <th className="text-left py-3 px-4 font-semibold text-primary-800">Periode</th>
                    <th className="text-center py-3 px-4 font-semibold text-primary-800">Tipe</th>
                    ...
                    <th className="text-center py-3 px-4 font-semibold text-primary-800">Confidence</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-primary-100">
                  ...
                  <tr className="hover:bg-gray-25">
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-vmeds-900">Hari Ini</span>
                      </div>
                    </td>
                    <td className="text-center py-3 px-4">
                    ...
                    <td className="text-center py-3 px-4 font-bold text-primary-700">72.5%</td>
                    <td className="text-center py-3 px-4 font-bold text-vmeds-700">7.2</td>
                    <td className="text-center py-3 px-4 font-bold text-success-700">3.8</td>
                    <td className="text-center py-3 px-4 font-bold text-warning-700">2.1</td>
                    <td className="text-center py-3 px-4 text-vmeds-600">-</td>
                  </tr>
                  ...
                  <tr className="hover:bg-blue-25 bg-blue-50">
                    ...
                    <td className="text-center py-3 px-4 font-bold text-blue-700">73.2%</td>
                    <td className="text-center py-3 px-4 font-bold text-blue-700">7.1</td>
                    <td className="text-center py-3 px-4 font-bold text-blue-700">3.9</td>
                    <td className="text-center py-3 px-4 font-bold text-blue-700">2.0</td>
                    <td className="text-center py-3 px-4">
                      <span className="px-2 py-1 bg-success-100 text-success-700 rounded-full text-xs font-medium">
                        95.1%
                      </span>
                  ...
                  <tr className="hover:bg-blue-25 bg-blue-50">
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                        <span className="font-medium text-blue-900">Lusa</span>
                      </div>
                    </td>
                    <td className="text-center py-3 px-4">
                      <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">
                    ...
                    <td className="text-center py-3 px-4 font-bold text-blue-700">74.1%</td>
                    <td className="text-center py-3 px-4 font-bold text-blue-700">7.0</td>
                    <td className="text-center py-3 px-4 font-bold text-blue-700">4.0</td>
                    <td className="text-center py-3 px-4 font-bold text-blue-700">1.9</td>
                    <td className="text-center py-3 px-4">
                      <span className="px-2 py-1 bg-success-100 text-success-700 rounded-full text-xs font-medium">
                        92.8%
                      </span>
                  ...
                  <tr className="hover:bg-blue-25 bg-blue-50">
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                        <span className="font-medium text-blue-900">3 Hari</span>
                      </div>
                    </td>
                    <td className="text-center py-3 px-4">
                      <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">
                    ...
                    <td className="text-center py-3 px-4 font-bold text-blue-700">75.0%</td>
                    <td className="text-center py-3 px-4 font-bold text-blue-700">6.9</td>
                    <td className="text-center py-3 px-4 font-bold text-blue-700">4.1</td>
                    <td className="text-center py-3 px-4 font-bold text-blue-700">1.8</td>
                    <td className="text-center py-3 px-4">
                  ...
                  <tr className="hover:bg-blue-25 bg-blue-50">
                    ...
                    <td className="text-center py-3 px-4 font-bold text-blue-700">75.8%</td>
                    <td className="text-center py-3 px-4 font-bold text-blue-700">6.8</td>
                    <td className="text-center py-3 px-4 font-bold text-blue-700">4.2</td>
                    <td className="text-center py-3 px-4 font-bold text-blue-700">1.7</td>
                    <td className="text-center py-3 px-4">
                      <span className="px-2 py-1 bg-warning-100 text-warning-700 rounded-full text-xs font-medium">
                        84.7%
                      </span>
            ...
            <div className="mt-4 flex justify-between items-center pt-4 border-t border-primary-200">
              <div className="flex gap-4 text-xs">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                  <span className="text-vmeds-600">Prediksi Machine Learning</span>
                </div>
              </div>
              <div className="text-xs text-vmeds-500">
                Trend Prediction: <span className="font-semibold text-success-700">Stabil ↗ +3.3%</span>
              </div>
            </div>
          </div>
        </div>
